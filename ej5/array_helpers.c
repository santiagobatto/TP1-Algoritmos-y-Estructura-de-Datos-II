...
/*
* La compilacion fallaba porque se estaba definiendo en multiples archivos a mybool.h

* Se soluciono usando #ifndef MYBOOL_H y #define MYBOOL_H en el archivo mybool.h
  que sirve para que el compilador no compile el archivo si ya fue compilado
  en otro archivo
*/
